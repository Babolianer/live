...
export default async function HomePage() {
  ...
  const [documentCount, contractCount, dueSoon] = await Promise.all([
    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-foreground-muted">
          Hier ist dein Überblick über Dokumente und Verträge.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          ...
          <Card className="flex flex-col items-center gap-2 py-4 text-center opacity-50">
            <TrendingUp size={18} />
            <span className="text-xs font-medium">Vermögen (bald)</span>
          </Card>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          ...
          <Card className="flex flex-col items-center gap-2 py-5 text-center opacity-60">
            <Target size={20} />
            <span className="text-xs font-medium">Ziele & Fortschritt</span>
          </Card>
          <Card className="flex flex-col items-center gap-2 py-5 text-center opacity-60">
            <HeartPulse size={20} />
